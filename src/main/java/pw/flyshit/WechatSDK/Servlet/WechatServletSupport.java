package pw.flyshit.WechatSDK.Servlet;
...
import pw.flyshit.WechatSDK.Msg.Req.BaseEvent;
import pw.flyshit.WechatSDK.Msg.Req.BaseReq;
import pw.flyshit.WechatSDK.Msg.Req.BaseReqMsg;
import pw.flyshit.WechatSDK.Msg.Req.EventType;
import pw.flyshit.WechatSDK.Msg.Req.ImageReqMsg;
import pw.flyshit.WechatSDK.Msg.Req.LinkReqMsg;
import pw.flyshit.WechatSDK.Msg.Req.LocationEvent;
import pw.flyshit.WechatSDK.Msg.Req.LocationReqMsg;
import pw.flyshit.WechatSDK.Msg.Req.MenuEvent;
import pw.flyshit.WechatSDK.Msg.Req.QrCodeEvent;
import pw.flyshit.WechatSDK.Msg.Req.ReqType;
import pw.flyshit.WechatSDK.Msg.Req.TextReqMsg;
import pw.flyshit.WechatSDK.Msg.Req.VideoReqMsg;
import pw.flyshit.WechatSDK.Msg.Req.VoiceReqMsg;
import pw.flyshit.WechatSDK.Util.MessageUtil;
import pw.flyshit.WechatSDK.Util.SignUtil;

/**
 * 处理微信请求的Servlet应继承此类，并按需要重写相关方法
 */
@SuppressWarnings("serial")
public abstract class WechatServletSupport extends HttpServlet {
